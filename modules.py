...
class Encoder(nn.Module):
    ...
    def forward(self, input_data):
        ...
        input_weighted = init_zeros(input_data.size(0), self.T - 1, self.input_size)
        input_encoded = init_zeros(input_data.size(0), self.T - 1, self.hidden_size)
...
class Decoder(nn.Module):
    ...
    def forward(self, input_encoded, y_history):
        ...
        context = init_zeros(input_encoded.size(0), self.encoder_hidden_size)
